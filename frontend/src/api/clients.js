...
export const receiptClient = createApiClient({ baseURL: '/api/receipts', timeout: 300000 })
...
export const announcementClient = createApiClient({ baseURL: '/api/announcements', timeout: 30000 })
