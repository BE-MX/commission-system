  ...
  <div>
    ...
    <div v-if="summary" class="summary-banner">
      ...
      <div class="summary-grid">
        ...
        <div class="summary-item">
          <div class="summary-label">主管提成</div>
    ...
    <el-row :gutter="16" class="toolbar">
      ...
      <el-col :span="2">
        <el-button @click="$router.push('/commission/batch')">返回列表</el-button>
      </el-col>
    </el-row>
    ...
    <el-table :data="tableData" v-loading="loading" stripe border>
      ...
      <el-table-column prop="supervisor_name" label="主管" width="90" />
      <el-table-column label="主管比例" width="80" align="right">
        <template #default="{ row }">{{ rateStr(row.supervisor_rate) }}</template>
      </el-table-column>
      <el-table-column label="主管提成" width="100" align="right">
