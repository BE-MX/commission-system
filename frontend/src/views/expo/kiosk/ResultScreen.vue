  ...
  <div class="result">
    ...
    <div v-if="!current" class="waiting">
      ...
      <div class="wait-title">
        ...
        <!-- 时长按 2026-07-31 实测改口径：单张 165~180s（历史 gen_ms 均值 118s、峰值 284s）。
             原文案「1-2 分钟」会让客户在第 150 秒认定系统卡了，销售还得圆场——
             承诺时长必须跟着实测走，改生图链路时一并复核这个数字 -->
        <small>预计 3 分钟左右 · AI 精细处理中</small>
      </div>
