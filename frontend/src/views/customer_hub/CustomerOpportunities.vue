  ...
  <div class="workflow">
    ...
    <el-dialog v-model="visible" title="更新客户机会" width="620">
      <el-form label-position="top" class="opportunity-form">
        ...
        <el-form-item v-if="needsEventEvidence" label="证据事件 ID（必填，逗号分隔）"><el-input v-model="form.evidenceEventIdsText" placeholder="例如 1024, 1025" /></el-form-item>
        <el-form-item label="证据事实 ID（可选，逗号分隔）"><el-input v-model="form.evidenceFactIdsText" /></el-form-item>
