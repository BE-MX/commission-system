<template>
  <div class="workflow customer-hub">
    ...
    <el-dialog class="customer-hub-dialog" v-model="resultsDialog" :title="`任务结果 · ${resultsJob?.name || ''}`" width="min(860px, calc(100vw - 32px))">
      ...
      <div v-if="resultsLoading || results.length" class="table-card"><el-table v-loading="resultsLoading" :data="results" border class="list-table">
