...
export function emptyInvoiceForm() {
  return {
    ...
    merchandiser_id: null, merchandiser_name: '',
...
export function normalizeHairRow(line = {}) {
  return {
    ...
    available_stock: line.available_stock == null ? null : Number(line.available_stock),
...
export function buildInvoicePayload(form, hairDiscount) {
  ...
  return {
    ...
    merchandiser_id: form.merchandiser_id || null,
