<template>
  <div class="media-group">
    <div v-if="editable" class="capture-actions">
      ...
      <button type="button" :disabled="disabled" @click="videoInput.click()"><Video :size="19" />相册视频</button>
    </div>
    ...
    <input ref="videoInput" class="capture-input" type="file" accept="video/mp4,video/quicktime,video/x-m4v,.mp4,.mov,.m4v" :disabled="disabled" aria-label="选择相册视频" @change="choose($event, 'videos')" />
...
const photoInput = ref(null), videoInput = ref(null)
