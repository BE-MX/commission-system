...
<style scoped>
.editor-outline { min-width: 0; overflow: auto; padding: 18px 12px; border-left: 1px solid var(--border-color); background: var(--card-bg); }
.outline-title { margin-bottom: 8px; color: var(--text-primary); font-size: 13px; font-weight: 700; }
