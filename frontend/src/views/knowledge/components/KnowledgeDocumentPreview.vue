...
<style scoped>
.knowledge-preview { max-height: 55vh; overflow: auto; padding: 22px; border: 1px solid var(--border-color); border-radius: var(--radius-lg, 12px); background: var(--toolbar-bg); }
...
.knowledge-preview :deep(.tiptap pre) { overflow: auto; padding: 10px 12px; border-radius: 9px; color: var(--card-bg); background: var(--sidebar-bg-to); }
