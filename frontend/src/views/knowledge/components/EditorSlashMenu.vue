...
<style scoped>
.slash-menu { position: fixed; z-index: 40; width: 290px; max-height: min(420px, 60vh); overflow: auto; padding: 6px; border: 1px solid var(--border-color); border-radius: 12px; background: var(--card-bg); box-shadow: 0 16px 40px rgba(26, 26, 46, .16); }
...
button.active .command-icon { border-color: var(--color-primary); color: var(--color-primary); background: var(--card-bg); }
