...
export const PREFIX_LABELS = {
  ...
  colorwork: '库存色块图',
  colorwork_download: '库存图直接下载',
  colorwork_edit: '实时库存图修改',
  colorwork_master: '原始库存图文件',
...
export const PAGE_PARENTS = {
  ...
  colorwork_download: 'colorwork',
  colorwork_edit: 'colorwork',
  colorwork_master: 'colorwork',
...
const ROW_GROUPS = [
  ...
  { label: '单据 · 订单与物流', prefixes: [
    ...
    'colorwork', 'colorwork_download', 'colorwork_edit', 'colorwork_master',
  ] },
