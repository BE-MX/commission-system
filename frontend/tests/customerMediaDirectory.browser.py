...
with sync_playwright() as p:
    ...
    expect(page.locator('input[webkitdirectory]')).to_have_count(0)
    ...
    print(json.dumps({'passed': ['directory actions fit short/long names at 3 widths', 'readonly hides deletion', 'image rendered', 'lightbox teleported and closed', 'legacy dialog has no upload', 'delete cancellation', 'confirmed delete refreshes directory and assets'], 'page_errors': errors}))
    browser.close()
