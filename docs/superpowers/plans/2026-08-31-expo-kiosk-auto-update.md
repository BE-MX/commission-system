...
- [x] **Step 1: Add JSON test support and write the failing parser test**
...
- [x] **Step 4: Run GREEN, then write failing policy tests**
...
- [x] **Step 5: Run policy RED, then implement the policy**
...
`fixedUrl` uses `URI`, accepts only HTTPS with a host, preserves explicit ports, discards the kiosk path/query/fragment, and appends only the compile-time fixed path. `validateDownloaded` implements every equality/rejection asserted above with no fallback.

- [x] **Step 6: Run parser and policy GREEN and commit**
...
- [x] **Step 1: Write failing engine tests with in-memory fakes**
...
- [x] **Step 2: Run RED and implement the synchronous engine**
...
- [x] **Step 1: Add failing redirect and signer-normalization tests**
...
- [x] **Step 2: Implement pinned manifest/APK I/O**
...
- [x] **Step 3: Implement archive validation**
...
- [x] **Step 4: Implement installer submission**
...
- [x] **Step 5: Implement receivers and manifest entries**
...
- [x] **Step 6: Run update tests plus `assembleDebug`, inspect merged manifest, commit**
...
- [x] **Step 2: Run RED, implement presentation and native overlay, run GREEN**
...
- [x] **Step 3: Expose current origin without a second setting**

Implemented final isolation boundary: `KioskUrl.get/origin` both derive only from the strict compiled `R.string.start_url`. The URL must be HTTPS with exact `/expo/kiosk` path and no userinfo/query/fragment; all runtime SharedPreferences, dialogs, reset/save paths and HTTP fallback were deleted rather than migrated.

- [x] **Step 4: Integrate exactly one cold-start check**
...
- [x] **Step 5: Preserve kiosk and Lock Task boundaries**
...
- [x] **Step 6: Run Android tests/build and commit**
...
- [x] **Step 1: Capture the current release-signing failure test**
...
- [x] **Step 2: Configure version 1.9/code 10 and fail-closed release signing**
...
- [x] **Step 3: Implement publisher prepare-only mode**
...
- [x] **Step 4: Prove publisher rejection and acceptance**
...
- [x] **Step 5: Implement atomic remote publication**
...
- [x] **Step 6: Add Nginx and operational documentation**
...
- [x] **Step 1: Run focused Android tests**
...
- [x] **Step 2: Run complete project verification for the touched surfaces**
...
- [x] **Step 3: Inspect generated APK and manifest**
...
- [x] **Step 4: Dispatch independent adversarial review**
...
- [x] **Step 5: Sweep and final status**
