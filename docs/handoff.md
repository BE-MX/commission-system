...
- 任务分支 `codex/receipt-net-amount`；未push origin/main。约定检查仍被8项既有前端基线失配阻断，本次未改这些文件。详见[核对报告](reports/2026-09-20-receipt-net-amount.md)，私有证据在主目录 `backend/tmp/receipt-net-amount/`。
