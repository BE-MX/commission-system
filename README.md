...
莱莎方舟平台，企业内部综合后台。包含提成管理、物流跟踪（含关键状态推送 + 物流日报）、运单上传（AI OCR）、客户归属、设计预约、用户/权限、AI 接入、方舟洞见（信源配置/行业情报/案例库/周会纪要）、备货管理（安全库存/销量备货一览/库存日报）、钉钉集成十大模块。详细说明见 [CLAUDE.md](./CLAUDE.md)。
