...
def upgrade():
    ...
    op.add_column("ark_battle_reports", sa.Column("poster_push_enabled", sa.Boolean(), nullable=False, server_default=sa.false(), comment="13:00/17:30 群海报开关"))
    op.create_table("ark_battle_report_deliveries",
        ...
        sa.Column("slot", sa.String(5), nullable=False, comment="投递时段：13:00 或 17:30"),
