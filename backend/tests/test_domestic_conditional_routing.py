...
def test_domestic_attribute_migration_is_the_only_head_after_shipping_inspection():
    ...
    assert revisions.get_heads() == ["135_invoice_customer_overlays"]
    assert revisions.get_revision("135_invoice_customer_overlays").down_revision == "134_domestic_credit_shipdate"
    assert revisions.get_revision("134_domestic_credit_shipdate").down_revision == "133_domestic_customer_profile"
    assert revisions.get_revision("133_domestic_customer_profile").down_revision == "132_domestic_manual_price"
