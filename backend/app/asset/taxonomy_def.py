...
TAXONOMY_V2 = [
    ...
    {
        # 两级：产品族（发帘类/贴发类/接发条类/卡子发类）+ 具体产品（parent 挂靠同维度族值）。
        # 存量旧标签大量只到族级（"接发"1247/"贴发"654/"发帘"303），族值让这些信息不丢；
        # 检索时选中族值自动展开全部子级（前端与 MCP 均按 parent 展开）
        "name": "product_type", "label": "产品类型",
        "is_single_select": 0, "is_required": 0, "sort_order": 3,
        "values": [
            # 产品族
            {"value": "发帘类", "name_en": "Weft", "aliases": ["发帘"]},
            {"value": "贴发类", "name_en": "Tape-in", "aliases": ["贴发", "Tape in"]},
            {"value": "接发条类", "name_en": "Tip Extension", "aliases": ["接发", "Pre-bonded"]},
            {"value": "卡子发类", "name_en": "Clip-in", "aliases": ["卡子发"]},
            # 发帘类
            {"value": "天才发帘", "name_en": "Genius Weft", "parent": "发帘类", "aliases": ["天才"]},
            {"value": "双层天才", "name_en": "Double Drawn Genius Weft", "parent": "发帘类"},
            {"value": "加丝天才", "name_en": "Silk Genius Weft", "parent": "发帘类", "aliases": ["加丝天才发帘"]},
            {"value": "机织发帘", "name_en": "Machine Weft", "parent": "发帘类"},
            {"value": "鱼线发帘", "name_en": "Halo Weft", "parent": "发帘类", "aliases": ["Halo", "Fish Line"]},
            {"value": "打孔发帘-天才+天才", "name_en": "Hole Weft (Genius+Genius)", "parent": "发帘类"},
            {"value": "打孔发帘-天才+PU", "name_en": "Hole Weft (Genius+PU)", "parent": "发帘类"},
            {"value": "打孔发帘-机织+PU", "name_en": "Hole Weft (Machine+PU)", "parent": "发帘类"},
            {"value": "打孔发帘-机织+机织", "name_en": "Hole Weft (Machine+Machine)", "parent": "发帘类"},
            # 贴发类
            {"value": "普通贴发", "name_en": "Regular Tape-in", "parent": "贴发类"},
            {"value": "机织贴发", "name_en": "Machine Weft Tape-in", "parent": "贴发类"},
            {"value": "双层贴发", "name_en": "Double Sided Tape-in", "parent": "贴发类", "aliases": ["半片贴发"]},
            {"value": "迷你贴发", "name_en": "Mini Tape-in", "parent": "贴发类", "aliases": ["Mini贴发"]},
            {"value": "机织长条贴发", "name_en": "Long Tape Machine Weft", "parent": "贴发类"},
            # 接发条类
            {"value": "平型", "name_en": "Flat Tip", "parent": "接发条类"},
            {"value": "迷你平型", "name_en": "Mini Flat Tip", "parent": "接发条类"},
            {"value": "棒棒", "name_en": "I-Tip", "parent": "接发条类", "aliases": ["Stick Tip"]},
            {"value": "迷你哑光棒棒", "name_en": "Mini Matte I-Tip", "parent": "接发条类", "aliases": ["哑光棒棒"]},
            {"value": "铁丝", "name_en": "Nano Ring", "parent": "接发条类", "aliases": ["Nano Tip"]},
            {"value": "Y-tip", "name_en": "Y-Tip", "parent": "接发条类"},
            {"value": "指甲", "name_en": "U-Tip", "parent": "接发条类", "aliases": ["Nail Tip"]},
            {"value": "塑料头接发", "name_en": "Plastic Tip Extension", "parent": "接发条类"},
            {"value": "尼龙绳接发", "name_en": "Nylon Loop Extension", "parent": "接发条类"},
            {"value": "羽毛接发", "name_en": "Feather Extension", "parent": "接发条类"},
            {"value": "拉环双头接发", "name_en": "Pull-Loop Double Tip", "parent": "接发条类"},
            # 卡子发类
            {"value": "普通卡子发", "name_en": "Regular Clip-in", "parent": "卡子发类"},
            {"value": "机织卡子发", "name_en": "Machine Weft Clip-in", "parent": "卡子发类"},
            {"value": "半片PU卡子发", "name_en": "Half PU Clip-in", "parent": "卡子发类"},
            {"value": "蕾丝卡子发", "name_en": "Lace Clip-in", "parent": "卡子发类"},
            # 顶层其他
