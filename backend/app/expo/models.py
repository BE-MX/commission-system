...
class ExpoWig(Base):
    ...
    __table_args__ = (Index("idx_ark_expo_wigs_active", "is_active"),)
...
class ExpoHairColor(Base):
    ...
    __table_args__ = (Index("idx_ark_expo_hair_colors_active", "is_active"),)
...
class ExpoScript(Base):
    ...
    source_version = Column(String(16), nullable=False, default="v4")
    is_active = Column(Integer, nullable=False, default=1)
    created_at = Column(DateTime, nullable=False, default=datetime.utcnow)
    updated_at = Column(DateTime, nullable=False, default=datetime.utcnow, onupdate=datetime.utcnow)

    __table_args__ = (Index("idx_ark_expo_scripts_type", "script_type", "is_active"),)
...
class ExpoSession(Base):
    ...
    id = Column(BigInteger, primary_key=True, autoincrement=True)
    customer_id = Column(BigInteger, ForeignKey("ark_expo_customers.id", ondelete="CASCADE"), nullable=False)
...
class ExpoResult(Base):
    ...
    id = Column(BigInteger, primary_key=True, autoincrement=True)
    session_id = Column(BigInteger, ForeignKey("ark_expo_sessions.id", ondelete="CASCADE"), nullable=False)
    ...
    gen_ms = Column(Integer, nullable=True)
...
class ExpoFeedback(Base):
    ...
    sales_user_id = Column(Integer, nullable=False)
