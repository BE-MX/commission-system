...
class ExpoWig(Base):
    ...
    selling_points = Column(Text, nullable=True, comment="卖点（核心卖点+吸引点），话术生成引用")
    sales_description = Column(Text, nullable=True, comment="销售描述（发型特点解说+门店一句话解说），话术引用；与生图用 wig_description 分离")
