...
class SearchJob(AuditMixin, Base):
    ...
    result_count = Column(Integer, nullable=False, default=0, comment="通过去重并关联到任务的候选数")
    ...
    public_pool_deduplicated_count = Column(Integer, nullable=False, default=0, comment="命中OKKI公海客户而拦截的候选数")
