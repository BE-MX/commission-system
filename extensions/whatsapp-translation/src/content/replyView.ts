...
export const REPLY_COPY: Record<string, string> = {
  ...
  reply_goal_too_long: '本次目标超过当前服务字符上限，请缩短。', reply_invalid_response: '话术响应格式或请求标识不匹配，请重新生成；反复出现请检查前后端版本。',
  reply_model_format_invalid: '模型未返回完整可解析的回复格式，请重新生成。',
  reply_model_empty: '模型没有返回回复正文，请重新生成。',
  reply_model_too_long: '模型返回的正文超过展示容量，请使用更简短风格重新生成。',
  reply_history_summary_invalid: '长历史整理未返回可用摘要，请重新生成。',
